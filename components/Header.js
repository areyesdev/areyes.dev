...
export default function Header () {
  ...
  return (
    <nav className='sticky-nav flex justify-between items-center max-w-4xl w-full p-8 my-0 md:my-8 mx-auto bg-white dark:bg-black bg-opacity-60'>
      ...
      <div>
        <NextLink href='/'>
          <a className='p-2 md:p-4 text-gray-900 dark:text-gray-100'>HOME</a>
        </NextLink>
        <NextLink href='/about'>
          <a className='p-2 md:p-4 text-gray-900 dark:text-gray-100'>SOBRE MI</a>
        </NextLink>
        <NextLink href='/usos'>
          <a className='p-2 md:p-4 text-gray-900 dark:text-gray-100'>USOS</a>
        </NextLink>
        <NextLink href='/blog'>
